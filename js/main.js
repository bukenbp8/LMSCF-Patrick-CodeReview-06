...
var Home = /** @class */ (function () {
    function Home(name, picture, description, address, zip, createdDate, createdTime) {
        this.name = name;
...
var Loc = /** @class */ (function (_super) {
    ...
    function Loc(name, picture, description, address, zip, createdDate, createdTime) {
        var _this = _super.call(this, name, picture, description, address, zip, createdDate, createdTime) || this;
        locaCity.push(_this);
        return _this;
    }
    return Loc;
...
var Res = /** @class */ (function (_super) {
    ...
    function Res(name, picture, description, address, zip, tel, web, createdDate, createdTime) {
        var _this = _super.call(this, name, picture, description, address, zip, createdDate, createdTime) || this;
        _this.tel = tel;
        _this.web = web;
...
var Eve = /** @class */ (function (_super) {
    ...
    function Eve(name, picture, description, address, zip, web, time, date, price, createdDate, createdTime) {
        var _this = _super.call(this, name, picture, description, address, zip, createdDate, createdTime) || this;
        _this.web = web;
        _this.time = time;
        _this.date = date;
...
var poznanCityHall = new Loc("Ratusz Poznanski", "./img/Ratusz.jpg", "City Hall and City Center", "plac Kolegiacki 17", "61-841, Poznan", "24.10.2016", "10:00");
var poznanCathedral = new Loc("Poznan Cathedral", "./img/cathedral.jpg", "The biggest of many Churches", "Ostrów Tumski 17", "61-109, Poznan", "25.10.2017", "11:34");
var poznanBrama = new Loc("Brama Poznania", "./img/brama.jpg", "Museum of Polish History", "Gdańska 2", "61-123 Poznań, Poland", "26.10.2016", "18:23");
// Create "restaurant" objects
var rynek = new Res("Rynek 95", "./img/rynek.jpg", "Local cuisine, Polish, Bar, European", "ul. Stary Rynek 95", "61-773, Poland", "+48 884 810 004", "https://www.facebook.com/rynek95", "24.12.2018", "12:00");
var yetztu = new Res("YetzTu", "./img/yetztu.jpg", "Japanese, Asian, Soups", "Krysiewicza 6", "61-825, Poland", "+48 61 840 17 12", "https://www.facebook.com/yetztupoznan/", "15.4.2018", "19:26");
var oberza = new Res("Oberza Pod Dzwonkiem", "./img/oberza.jpg", "Polish, Central European, Vegetarian Friendly", "Garbary 54", "61-758, Poland", "+48 61 851 99 70", "https://www.facebook.com/poddzwonkiem", "5.5.2019", "3:00");
// Create "event" objects
var marathon = new Eve("Poznan Marathon", "./img/marathon.jpg", "Starts at Grunwaldzka street Gate 5", "", "", "https://halfmarathon.poznan.pl/en/", "8:00 AM", "05.04.2020", "95 PLN", "21.6.2019", "15:06");
var animator = new Eve("Animator Festival", "./img/animator.jpg", "Animated Movies Festival", "Kino Muza, ul. Św. Marcin 30", "", "http://www.animator-festival.com/en/", "4.00 pm", "10 - 17.7.2020", "15 PLN", "4.6.2019", "6:06");
var fest = new Eve("Malta Festival", "./img/malta.jpg", "Music and Art Festival at Lake Malta", "", "", "https://malta-festival.pl/en/", "see schedule", "21 - 30.06.2020", "FREE", "1.4.2019", "5:12");
// builds home 
